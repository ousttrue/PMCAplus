...
class SCALE_DIALOG_FANC:
    def __init__(self, app, root, sel):
        ...
        self.app.transform_data.append(
            PyPMCA.MODEL_TRANS_DATA(
                name=self.app.transform_list[self.sel].name,
                scale=1.0,
                bones=[],
                pos=[0.0, 0.0, 0.0],
                rot=[0.0, 0.0, 0.0],
    ...
    def OK(self):
        self.app.transform_data[0].scale = (
            self.data.scale * self.app.transform_data[0].scale
        )
        ...
        for x in self.data.bones:
            ...
            for y in self.app.transform_data[0].bones:
                ...
                self.app.transform_data[0].bones.append(
